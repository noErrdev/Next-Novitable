  ...
  return (
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        {/* Top area: Blocks */}
        <div className="grid place-items-center  sm:grid-cols-12 gap-8 py-8 pr-12 pl-12 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-12 md:col-span-4 lg:col-span-4">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <a href="#0" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Private policy</a>
              </li>
              <li className="mb-2">
                ...
                <div className="w-full">
                  ...
                  <div className="relative flex items-center max-w-xs">
                    ...
                    <button type="submit" className="absolute inset-0 left-auto" aria-label="Subscribe">
                      ...
                      <svg className="w-3 h-3 fill-current text-yellow-700 mx-3 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; Novi table.com. All rights reserved.</div>
